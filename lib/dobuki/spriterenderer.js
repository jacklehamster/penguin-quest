    ...
    function collectImages(spriteContainer) {
        ...
        for(var i=0;i<numSprites;i++) {
            ...
            if(cut) {
                ...
                image.position[0] = Math.round(sprite.pos[0]*64 + offsetX - shift.x*64)/64;
                image.position[1] = Math.round(sprite.pos[1]*64 + offsetY - shift.y*64)/64;
                ...
                if(cut.size) {
                    image.size[0] = cut.size[0]/64;
                    image.size[1] = cut.size[1]/64;
                } else {
